...
if (!defined('_ARTX_FUNCTIONS')) {
	...
	function artxReplaceButtons($content)
	{
		...
		foreach ($matches[0] as $match) {
			...
			$result .= '<span class="a2-button-wrapper"><span class="l"> </span><span class="r"> </span>'
				. preg_replace('~\bclass=(?:"([^"]*\s)?button(\s[^"]*)?"|\'([^\']*\s)?button(\s[^\']*)?\'|button\b)~i',
					'class="\1\3button a2-button\2\4"', $match[0]) . '</span>';
		}
...
?>
<div class="a2-Block">
		    <div class="a2-Block-tl"></div>
		    <div class="a2-Block-tr"></div>
		    <div class="a2-Block-bl"></div>
		    <div class="a2-Block-br"></div>
		    <div class="a2-Block-tc"></div>
		    <div class="a2-Block-bc"></div>
		    <div class="a2-Block-cl"></div>
		    <div class="a2-Block-cr"></div>
		    <div class="a2-Block-cc"></div>
		    <div class="a2-Block-body">
		
		<?php if ($hasCaption): ?>
<div class="a2-BlockHeader">
		    <div class="l"></div>
		    <div class="r"></div>
		    <div class="a2-header-tag-icon">
		        <div class="t">
		<?php echo $caption; ?>
</div>
		    </div>
...
<div class="a2-BlockContent">
		    <div class="a2-BlockContent-tl"></div>
		    <div class="a2-BlockContent-tr"></div>
		    <div class="a2-BlockContent-bl"></div>
		    <div class="a2-BlockContent-br"></div>
		    <div class="a2-BlockContent-tc"></div>
		    <div class="a2-BlockContent-bc"></div>
		    <div class="a2-BlockContent-cl"></div>
		    <div class="a2-BlockContent-cr"></div>
		    <div class="a2-BlockContent-cc"></div>
		    <div class="a2-BlockContent-body">
...
<?php
	...
	function my_artxBlock($caption, $content)
	{
		...
		ob_start();
?>
<div class="my-a2-Block">
		    <div class="my-a2-Block-tl"></div>
		    <div class="my-a2-Block-tr"></div>
		    <div class="my-a2-Block-bl"></div>
		    <div class="my-a2-Block-br"></div>
		    <div class="my-a2-Block-tc"></div>
		    <div class="my-a2-Block-bc"></div>
		    <div class="my-a2-Block-cl"></div>
		    <div class="my-a2-Block-cr"></div>
		    <div class="my-a2-Block-cc"></div>
		    <div class="my-a2-Block-body">
		
		<?php if ($hasCaption): ?>
<div class="my-a2-BlockHeader">
		    <div class="l"></div>
		    <div class="r"></div>
		    <div class="my-a2-header-tag-icon">
		        <div class="t">
		<?php echo $caption; ?>
</div>
		    </div>
		...
		<?php endif; ?>
		<?php if ($hasContent): ?>
<div class="my-a2-BlockContent">
		    <div class="my-a2-BlockContent-tl"></div>
		    <div class="my-a2-BlockContent-tr"></div>
		    <div class="my-a2-BlockContent-bl"></div>
		    <div class="my-a2-BlockContent-br"></div>
		    <div class="my-a2-BlockContent-tc"></div>
		    <div class="my-a2-BlockContent-bc"></div>
		    <div class="my-a2-BlockContent-cl"></div>
		    <div class="my-a2-BlockContent-cr"></div>
		    <div class="my-a2-BlockContent-cc"></div>
		    <div class="my-a2-BlockContent-body">
...
<?php
	...
	function artxComponentWrapper(&$document)
	{
		...
		if (false === strpos($content, '<div class="a2-Post">')) {
			$title = null;
